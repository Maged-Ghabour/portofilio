...
function maged_portfolio_scripts() {
	...
	wp_enqueue_style( 'maged-portfolio-style', get_template_directory_uri() . '/assets/css/style.css', array(), '1.0.0' );
	...
	wp_enqueue_script( 'maged-portfolio-script', get_template_directory_uri() . '/assets/js/script.js', array('jquery', 'typed-js', 'aos-js'), '1.0.0', true );
